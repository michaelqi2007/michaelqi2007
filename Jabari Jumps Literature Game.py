...
while validInput == True:
    ...
    if "easy" in command.lower():
        if "no" in command.lower() and EasyQuestionOne == False:
            print()
        print("You are entering easy difficulty! Questions here are worth 1 point. This is where you will be tested on your typing skills and speed. The sentences you type will be senteces from Jabari Jumps.") 
        print()
